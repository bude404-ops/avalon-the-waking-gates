...
- Form: SMALL PIXIE-SHAPED raven-beings (Big's refinement, Sept 8 ~11:14 PM: 'more shaped like pixies but all the raven features'). THE PIXIE IS THE SHAPE, THE RAVEN IS THE FLESH: delicate slender upright pixie body and proportions, standing on two legs, fine articulated arms and hands — rendered ENTIRELY in raven features: sleek black corvid feathers for skin, a raven's sharp beak for the face, darkly intelligent raven eyes, RAVEN-LIKE HANDS AND FEET, never human (Big, Sept 8 ~11:27 PM: 'hand and feet should be raven like not human') — hands are corvid TALON-HANDS: feathered bird-talon grippers with sharp black claws, a raven's-foot anatomy used for gripping; feet are full CORVID BIRD FEET: scaled bird legs, three forward toes + one back, black talons — and great black-feathered CORVID WINGS folded at the back like a pixie's wings. Never a feathered human, never a plain bird.
- Function: THEY CARRY THE RELICS. THE FLAME IS NEVER SEEN UNVESSELLED — the living flame travels in the Ravenkin's RELIQUARY PENDANT, worn at its neck (RELIQUARY PENDANT LAW, Big, Sept 11 ~1:54 AM: 'My thoughts for the reliquary is to be a pendant sized item but need to be unique to hold the essence of belief from the dieties in it and glow their essence color as the radiant light for players, that hangs from the ravenkins neck'): RELIC = the living flame (the LUMINARY, our Grail — it consents, it alights of its own will, it cannot be crafted or looted, only entrusted); VESSEL = the RELIQUARY PENDANT — PENDANT-SIZED, worn hanging from the Ravenkin's neck (supersedes the in-arms carriage as the standard bearer depiction; in-arms only for procession/recovery staging); UNIQUE — a one-of-a-kind vessel, singular mortal craft, never a manufacturable object; it holds the ESSENCE OF BELIEF from the deities; and it GLOWS THE DEITY'S ESSENCE COLOR as the radiant light for players — the pendant's glow takes the patron deity's color per the Reliquary-Region Aura Law (Skyrend storm slate / Ashfall oxide red / Stoneheart bone grey / Duskmourn crimson / Marenth tide teal / Everbloom deep moss), so the light a player walks by IS the god's color. The Ravenkin carry living light in a vessel. Ravenkin = the living reliquaries of the world; wherever a relic must be carried, guarded, delivered, or recovered, a Ravenkin bears it.
...
- Staging: small against the mythic world — a Ravenkin on a standing-stone avenue with the reliquary pendant glowing at its neck reads as a tiny warm light inside the colossal carved cold.
- Art grammar: Carved-World painterly oil-render, silhouette-first at phone scale; the pendant reliquary is the only warm light source on the bird (Two-Layer Light law); no craft on the Ravenkin themselves (no armor, no tools — the relic is the burden and the honor).
