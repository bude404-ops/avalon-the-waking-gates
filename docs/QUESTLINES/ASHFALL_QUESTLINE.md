# ASHFALL — THE COLD MERE (Ashfall chapter questline · QUEST DOCTRINE PILOT)
...
- **ECHO:** The fleet rides at anchor or at sea; the ledger-keeper greets the pilgrim warmly or coldly in every later Marenth town.
...
The **Ashfall Depths** (procedural fracture dungeons) = **the Furnace King's fever of the forge** — layouts of half-poured castings, tribute-flood vaults, kilns burning in dreams. Every depth-run yields one witnessable fragment (a Tidal Greatblade cast in forge-slag — Nerovane's debt to Vaelthorn, seen not read). The Gate Cycle endgame ticks behind the chapter: an unfed Cinder Gate slides the Ashfall toward Hollow (Diablo pillar, questline is the feeder).
