...
- **THE NARROW WAYS:** Mortals live at human scale — in dungeon depths, shrine villages, pilgrim roads, sunken quarters. A hundred-foot god cannot enter a crypt, question a villager, or walk a market street without turning faith into terror. So the gods work through the MARKED: pilgrims who carry relic-light (the Cold Reliquary), whose deeds at mortal scale feed the Gate. The divine tell is subtle: the hand-carved flame Mark on the breastplate, and element-touched eyes that glow a shade too steady — 'one of us, but the fire does not flicker.'
