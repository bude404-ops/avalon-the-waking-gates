...
3. Void-tether severing (reliquary toggle mid-fight)
...
| Keeper | mace + reliquary | MEDIUM | mid |
...
| MACE-AND-RELIQUARY | Sexton | rite-blows (mace), tether-sever strikes | Reliquary rites: reveal surges, faith-ward auras |
