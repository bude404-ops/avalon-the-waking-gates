# THE CAMELOT BESTIARY — Arthurian Creature & Magic Framing (Sept 8 2026, Big: 'I also like the idea of Camelot style creatures and magic' → green-lit)

Avalon is the dark mirror of Camelot: the king is dead, the knights are hollow, the light went out. The creature layer pulls from the REAL Arthurian bestiary instead of generic fantasy; the magic layer speaks Merlin's verbs.

## I. SCOPE — WHAT THIS TOUCHES
- RE-FLAVORED: realm fauna (shade-beasts), realm elites, dead-god boss flavor, wild-zone creatures, their names and lore framing.
- UNTOUCHED: the locked Hollow roster (Undone, Unmade Champion, Crucible-Bearer, Erased Drake, T3 Echo, Gate Worm) — the human horror layer stays exactly as canon. THE OATHLESS is already peak Arthurian (fallen knight-elite).
...
## III. THE MAGIC — Merlin's three verbs (no fireballs)
1. WONDER — miracles are rare, quiet, awesome. The Mark rites are renamed ENCHANTMENTS with romance language (attunement = an enchantment laid at a shrine).
2. OATH — spoken vows with real power: tribute rites are oath-bindings; the Knight's 'Sir' is earned by an oath sworn at a gate; breaking an oath has mechanical teeth (the Oathless are what oath-breakers become).
