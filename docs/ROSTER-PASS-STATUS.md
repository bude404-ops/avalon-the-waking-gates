...
- CLASS ARMOR LAW (Sept 7 evening, Big: 'assassin type is leathers casters are some armor but robes'): armor material grammar fixed per class — Singer LEATHERS, Walker ROBES+light armor, Vigil ranger leathers, Warden mid plate, Keeper lamellar, Smith heavy plate. Cinder Roads wear stays. Law in PILGRIM-COMBAT-SYSTEM.md (commit ca8273fe2).
- SINGER CANON V2 SENT Sept 7 evening: PILGRIM-CLASS-SINGER-SMALL-CANON-V2-LEATHERS.png (art/pending/) — v1 re-rolled under the armor law: hooded stitched leather jerkin, quiet cloth, wrapped boots, zero metal. Same scene, same small frame vs milestone arch, lantern companion. v1 (scale-mail) superseded — non-compliant with armor law.
