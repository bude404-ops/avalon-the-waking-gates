...
- FEMALE ATTIRE LAW (Sept 7, Big: 'we still need make the females sexy and seductive with their attire'): female variants cut for allure within class-material grammar (fitted bodices, laced corsetry, slits, thigh boots — seductive tailoring, never explicit). Law in PILGRIM_DESIGN_DOCTRINE.md. Female Wayfarer v2 roll queued.
