...
- WAYFARER CANON V2 (leathers) SENT Sept 7 evening — the image Big has is correct; only the NAME was wrong (sent as 'Singer'). NAME LAW (Sept 7 night, Big caught it: 'Isnt it wayfarer?'): THE ORDER NAMES ARE FINAL per his Sept 5 ruling ('I like wayfarer and cantor') — dagger class = WAYFARER, staff class = CANTOR. Singer/Walker were retired discipline names that leaked back into the Size Law doc; purged from all live docs. Live v2 file: PILGRIM-ORDER-WAYFARER-SMALL-CANON-V2.png (p-hash twin of the sent image). v1 (scale-mail) superseded — non-compliant with armor law.
